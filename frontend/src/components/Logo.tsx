export function LogoMark({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="40" height="40" rx="11" fill="url(#quizme-gradient)" />
      <path
      ...
      <defs>
        <linearGradient id="quizme-gradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <div className="leading-tight">
        <span className="block text-lg font-extrabold tracking-tight text-ink-900">
          QUIZ<span className="text-brand-600">ME</span>
        </span>
